...
module.exports = function (RED) {
     ...
     * @returns
     */
    function decodeDALICommand(commandName) {
        let result = {
            command: -1
        };
     ...
     * @returns
     */
    function prepareDALIRequest(registryName, uint16h, uint16l) {
    ...
    function decodeDALIresponse(modbusResponse) {
        let payload = new Object();
        let result = {
            modbus_fc: -1,
            registry: -1
    ...
    RED.nodes.registerType("dali-query", function (config) {
        RED.nodes.createNode(this, config);
        this.on("input", (msg, send, done) => __awaiter(this, void 0, void 0, function* () {
            msg.payload = prepareDALIRequest(msg["registry-name"], msg["dali-address"], decodeDALICommand(msg["command"]));
            if (typeof msg.payload.fc == "undefined")
                msg.payload["fc"] = config["modbus-function"];
            if (typeof msg.payload.unitid == "undefined")
                msg.payload["unitid"] = config["modbus-unitid"];
            send(msg);
            done();
        }));
    });
    RED.nodes.registerType("dali-lamp-level", function (config) {
        RED.nodes.createNode(this, config);
        this.on("input", (msg, send, done) => __awaiter(this, void 0, void 0, function* () {
            send(msg);
            done();
    ...
    RED.nodes.registerType("dali-response", function (config) {
        RED.nodes.createNode(this, config);
        this.on("input", (msg, send, done) => __awaiter(this, void 0, void 0, function* () {
            this.status({
                fill: "green",
...
//# sourceMappingURL=resi-dali-modbus-gateway.js.map